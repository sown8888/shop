...
timer: 5000
});setTimeout(function(){ location.href = "/mua-follow" },5000);
</script>
    <?php 
    } else if($sl < 20) { ?>
<script type="text/javascript">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="sv1">sv1 <small>(Follow người dùng chéo, tài khoản tên Việt, có Avatar)</small>&nbsp;<span class="badge border border-success text-success">15 coin / 1 follow</span>&nbsp;<b class="text-warning">(Hoạt động)</b></label>
                                                </div>
                                            </div>
                                                                                    </div>
                                    </div>
