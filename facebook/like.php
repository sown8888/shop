...
timer: 5000
});setTimeout(function(){ location.href = "/mua-like" },5000);
</script>
    <?php 
    } else if($sl < 20) { ?>
<script type="text/javascript">
cuteToast({
type: "error",
message: "Mua Tối Thiểu 50 Like Trở Lên !",
timer: 5000
});setTimeout(function(){ location.href = "/mua-like" },5000);
</script>   
<?php } else {
...
$create = $ketnoi->query("INSERT INTO `mualikefb` SET 
        `idtang` = '$id',
        `sl` = '$sl',
        `username` = '$username',
        `time` = '$time' ");
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="sv1">sv1 <small>(Like người dùng chéo, tài khoản tên Việt, có Avatar)</small>&nbsp;<span class="badge border border-success text-success">10 coin / 1 like</span>&nbsp;<b class="text-warning">(Hoạt động)</b></label>
                                                </div>
                                            </div>
                                                                                    </div>
                                    </div>
...
<?php
                                $i = 1;
                                $query = mysqli_query($ketnoi, "SELECT * FROM `mualikefb` WHERE `username` = '$username' ORDER BY id DESC limit 5");
