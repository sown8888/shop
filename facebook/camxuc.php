$t<?php require_once('../config/head.php'); ?>
...
timer: 5000
});setTimeout(function(){ location.href = "/mua-camxuc" },5000);
</script>
    <?php 
    } else if($sl < 20) { ?>
<script type="text/javascript">
...
"referer:https://traodoisub.com/mua/reaction/",
);
$data = 'maghinho=&id='.$id.'&sl='.$sl.'&dateTime='.$tong.'&loaicx='.$cx.'&speed=1';
$mr = curl_init();
curl_setopt($mr, CURLOPT_URL, 'https://traodoisub.com/mua/reaction/themid.php');
...
$create = $ketnoi->query("INSERT INTO `muareaction` SET 
        `idtang` = '$id',
        `sl` = '$sl',
        `cx` = '$cx',
        `username` = '$username',
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="sv1">sv1 <small>(Cảm xúc người dùng chéo, tài khoản tên Việt, có Avatar)</small>&nbsp;<span class="badge border border-success text-success">10 coin / 1 cảm xúc</span>&nbsp;<b class="text-warning">(Hoạt động)</b></label>
                                                </div>
                                            </div>
                                                                                    </div>
                                    </div>
...
<input class="form-check-input checkbox d-none" type="radio" data-prices="100" id="reaction4" name="reaction" value="wow"><img src="https://subgiare.vn/assets/images/fb-reaction/wow.png" alt="image" class="d-block ml-2 rounded-circle" width="35">
</label>
</div>
...
$data = 'page=1&query=';
$mr = curl_init();
curl_setopt($mr, CURLOPT_URL, 'https://traodoisub.com/mua/reaction/fetch.php');
curl_setopt($mr, CURLOPT_RETURNTRANSFER, TRUE);
curl_setopt($mr, CURLOPT_COOKIEFILE, 'file.txt');
curl_setopt($mr, CURLOPT_POSTFIELDS, $data);
curl_setopt($mr, CURLOPT_HTTPHEADER, $header);
